var timeout = 30000;
var baseUrl = 'https://www.epam.com/';
...
exports.config = {
    ...
    // Specify Test Files
    // ==================
    // Define which src specs should run. The pattern is relative to the directory
    ...
    // Hooks
    // =====
    // WebdriverIO provides several hooks you can use to interfere with the src process in order to enhance
     ...
     * @param {Object} src src details
     */
    // beforeTest: function (src) {
    // },
    /**
    ...
    // },
    /**
     * Function to be executed after a src (in Mocha/Jasmine) or a step (in Cucumber) starts.
     * @param {Object} src src details
     */
    // afterTest: function (src) {
    // },
    /**
